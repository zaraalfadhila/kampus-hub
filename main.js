...
const formPencarian =
    document.getElementById("formPencarian");
...
if (formPencarian) {
    ...
    const daftarMahasiswa =
        document.getElementById("Daftar-Mahasiswa");
    ...
    formPencarian.addEventListener(
        "submit",
        function (event) {
            ...
            if (!mahasiswaTerpilih) {
                ...
                alert(
                    "Silakan pilih nama mahasiswa terlebih dahulu."
                );
